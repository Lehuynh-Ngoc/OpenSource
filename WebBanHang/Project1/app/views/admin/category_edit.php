...
<body class="bg-gray-100 min-h-screen">
    <div class="flex">
        ...
        <div class="flex-1 p-10">
            <div class="mb-10">
                <h2 class="text-3xl font-black text-gray-800 uppercase tracking-tighter">Sửa danh mục</h2>
                <p class="text-gray-500 font-medium">Cập nhật thông tin danh mục #<?= $category['id'] ?></p>
            </div>

            <div class="bg-white rounded-3xl shadow-sm p-8 border border-gray-100 max-w-2xl">
                <form action="/Project1/admin/category_update/<?= $category['id'] ?>" method="POST" class="space-y-6">
                    <div>
